...
def loadMoneyWindow():
    ...
    userLabel = Label(loadMoneyWindow, text="Your Transaction ID:", background='light yellow',font=com15)
    userLabel.place(x=110,y=120)
    userLabel = Label(loadMoneyWindow, text="IBAN: 682734598269 ", background='powder blue',font=com15)
