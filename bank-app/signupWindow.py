...
def signupWindow():
    ...
    DOBLabel = Label(signupView, text="Date Of Birth:", wraplength=300, font=com12)
    ...
    # Create Ac Button:
    createAC = Button(signupView, text="Create Account", wraplength=300, background="PaleGreen1", font=com12, command=signedIN)
    ...
    link = Label(signupView, text="Help", font=('Helvetica bold', 12), fg="blue", cursor="hand2", underline=1)
    link.place(x=10, y=335)
    link.bind("<Button-1>", lambda t: callURLfunc("https://www.bankalhabib.com/faqs"))
